...
const EventSponserPrice = () => {
    return (
        <div className=' w-[84rem] m-auto'>
            <div className="flex justify-between items-baseline mb-16">

                <div className="font-bold text-4xl z-30 text-gray-500">Organizers</div>
                <div className="uppercase text-9xl font-bold  text-gray-100  unselectable">Sponsorship</div>

            </div>
            <div class="flex items-center justify-center" >

                {/* <div class="bg-gradient-to-b from-pink-100 to-purple-200"> */}
                <div class="flex md:grid-cols-2 gap-4 transition-all duration-10">
                    <div class=" group mt-12 m-auto -space-y-4 items-center justify-center md:flex md:space-y-0   slidercontainer">
                        <div class="relative z-10 -mx-4 group md:mx-0 lg:w-full ">
                            <div aria-hidden="true" class="absolute top-0 w-full h-full rounded-2xl bg-white shadow-xl transition group-hover:scale-105 lg:group-hover:scale-110"></div>
                        ...
                        <div class="relative group  group-hover:flex transition slider">
                            <div aria-hidden="true" class="absolute top-0 inset-0 w-full rounded-2xl bg-white shadow-lg transition duration-500 group-hover:scale-105"></div>
