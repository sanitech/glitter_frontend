      ...
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          <div class="aspect-w-16 aspect-h-9 lg:aspect-none">
            <img class="w-full object-cover rounded-xl" src={meeting} alt="Image Description"/>
          ...
          <div>
            ...
            <div class="mb-4">
              <h3 class="text-xs font-medium uppercase text-orange-400">
                Steps
              </h3>
            </div>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="relative last:after:hidden after:absolute after:top-8 after:bottom-0 after:start-4 after:w-px after:-translate-x-[0.5px] after:bg-neutral-800">
                <div class="relative z-10 size-8 flex justify-center items-center">
                  <span class="flex flex-shrink-0 justify-center items-center size-8 border border-neutral-800 text-orange-400 font-semibold text-xs uppercase rounded-full">
                    1
                  </span>
                </div>
              </div>
            ...
            <Link to="/contact" class="group inline-flex items-center gap-x-2 py-2 px-3 bg-orange-500 font-medium text-sm text-neutral-800 rounded-full focus:outline-none" href="#">
