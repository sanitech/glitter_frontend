  ...
  return (
    <div>
      <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
        <nav
          class="mt-6 relative max-w-[85rem] w-full backdrop-blur-lg  z-20 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto "
          aria-label="Global"
        >
          <div class="flex items-center justify-between">
            <Link
              ...
              aria-label="Brand"
            >
            <img className="w-12" src={isDarkMode? logoDark : logo} alt="glitter logo" />
             <div className={`logo-text ${isDarkMode? 'text-gray-900' : 'text-gray-100'}`}>
             Glitter
             promotion
             </div>
            </Link>
          ...
          >
            <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7 dark:text-gray-400">
              <Link
                class="font-medium text-gray-50 md:py-6 dark:text-orange-500 text-lg"
                to="/"
                aria-current="page"
              >
                Home
              ...
              <Link
                class="font-medium text-gray-100 hover:text-gray-200 text-lg md:py-6 dark:text-gray-800 dark:hover:text-gray-600 "
                to="/aboutUs"
              >
                About us
              </Link>
              ...
              <Link
                class="font-medium text-gray-100 hover:text-gray-200 md:py-6 dark:text-gray-800 dark:hover:text-gray-600 text-lg"
                to="/blog"
              >
                Blog
              </Link>
              ...
              {/* <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--trigger:hover] md:py-4 text-lg">
                ...
                <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">
                  <a
                    class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-orange-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="#"
                  >
                    About
                  </a>
                  <div class="hs-dropdown relative [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover]">
                    <button
                      type="button"
                      class="w-full flex justify-between items-center text-sm text-gray-800 rounded-lg py-2 px-3 hover:bg-gray-100 focus:ring-2 focus:ring-orange-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    >
                      Sub Menu
                      <svg
