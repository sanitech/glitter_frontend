...
function ContactSection() {
  return (
    <div>
      <div class="bg-neutral-950 md:pt-10 pt-20">
            ...
            <div class="md:order-2 border-b border-neutral-800 pb-10 mb-10 md:border-b-0 md:pb-0 md:mb-0">
              <form>
                ...
                <div class="mt-2">
                  ...
                  <p class="mt-5">
                    <a
                      class="group inline-flex items-center gap-x-2 py-2 px-3 bg-orange-500 font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
                      href="#"
                    >
                      Submit
                      <svg
            ...
            <div class="space-y-14">
              ...
              <div class="flex gap-x-5">
                ...
                <div class="grow">
                  ...
                  <p class="mt-2">
                    <a
                      class="group inline-flex items-center gap-x-2 font-medium text-sm text-orange-500 decoration-2 hover:underline focus:outline-none focus:underline"
                      href="#"
                    >
                      Job openings
                      <svg
